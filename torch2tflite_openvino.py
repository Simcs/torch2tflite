...
def main(args: Namespace):
    ...
    # ===== 3. ONNX => OpenVINO =====
    ov_model, ov_path = onnx2openvino(onnx_path, args)
    print('=== Onnx to OpenVINO complete ===')

    # ===== 4. OpenVINO => Tensorflow =====
    tf_path = openvino2tensorflow(ov_path, args)
    print('=== OpenVINO to tensorflow lite complete ===')
