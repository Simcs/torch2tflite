...
from efficientnet.efficientnet_lite import efficientnet_lite_params
...
def define_flags():
    ...
    flags.DEFINE_string("export_directory", None,"Path to save the TFLite model files with metadata.")
...
image_size = efficientnet_lite_params["efficientnet_lite0"][2]
...
_MODEL_INFO = {
    ...
    "efficientnet_lite0.tflite":
        ModelSpecificInfo(
            name="UCC EfficientNet-Lite0 image classifier",
            version="v0",
